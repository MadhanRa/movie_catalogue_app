...
class TvShowAdapter : PagedListAdapter<TvShows , TvShowAdapter.TvShowViewHolder>(DIFF_CALLBACK) {
    ...
    inner class TvShowViewHolder(private val binding: ItemForRvBinding) : RecyclerView.ViewHolder(binding.root) {
